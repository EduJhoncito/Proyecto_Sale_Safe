...
public class Cocinas extends AppCompatActivity {
    ...
    private Button button3, _btnGrabar, _btnModificar, _btnEliminar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cocinas);
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent f = new Intent(Cocinas.this, Categoryys.class);
                startActivity(f);
                finish();
            }
        });
