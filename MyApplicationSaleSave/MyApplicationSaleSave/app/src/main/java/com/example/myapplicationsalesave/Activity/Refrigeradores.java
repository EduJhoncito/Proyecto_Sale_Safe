...
public class Refrigeradores extends AppCompatActivity {
    ...
    private Button button2, _btnGrabar, _btnModificar, _btnEliminar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_refrigeradores);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent n = new Intent(Refrigeradores.this, Categoryys.class);
                startActivity(n);
                finish();
            }
        });
